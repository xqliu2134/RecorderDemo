...
//        return new MyBinder();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        mWidthPixels = 1440;//intent.getIntExtra("mWidthPixels", 720);
        mHeightPixels = 1920;//intent.getIntExtra("mHeightPixels", 1080);
    ...
    private void createMediaRecorder() {
        ...
        //mMediaRecorder.setInputSurface();
...
//        //设置音频编码格式: default，AAC，AMR_NB，AMR_WB
        ...
        //设置视频输出路径
        mMediaRecorder.setOutputFile(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES) + "/recorder_" + curTime + ".mp4");
    ...
    private void initView() {
        ...
        wmParams.x = (getScreenWidth(getApplicationContext()) - wmParams.width) / 2;// 设置x、y初始值，相对于gravity
        wmParams.y = 10;
        // 浮动窗口布局
